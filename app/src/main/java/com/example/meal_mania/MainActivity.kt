...
//demo video link-https://drive.google.com/drive/u/1/folders/1ramOYvfOwbU_E3xG3ppNVmDdz2-UxQcK
...
class MainActivity : AppCompatActivity() {
    // Declaring private lateinit variables
    ...
    // Override the onCreate() method of the Activity class
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize the search and add meal buttons using their IDs from the layout
    ...
    //saving instances for the rotation
    ...
    // Saving by hardcoded, meal details for the Created Room library
